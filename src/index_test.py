...
def test_get_prime_list():
    ...
    # assert index.get_prime_list(567629137) == [67629137, 56729137]
    # assert index.get_prime_list(46216567629137) == []

def test_list_of_list():
    assert index.list_of_list([467, 457]) == [[67, 47], [47]]
    assert index.list_of_list([415673, 412567]) == [[45673], [41257]]
    # assert index.list_of_list([7, 3], [7], [3], [7, 3], [7], [7, 3], [7], [3], [7, 3], [7], [3], [7], [7], [7], [7], [7], [7, 3], [7], [3], [7, 3], [7], [7, 3], [7], [3], [7, 3], [7], [3], [7], [7], [7, 3], [7], [3], [7], [7], [7], [7], [7, 3], [7], [7], [7], [7], [7], [7, 3], [7], [3], [7, 3], [7], [7, 3], [7], [3], [7, 3], [7], [3], [7], [7], [7, 3], [7], [3], [7], [7], [7], [7], [7, 3], [7], [7], [7], [7], [7]) == [[5673, 4573, 4567], [1257]]
